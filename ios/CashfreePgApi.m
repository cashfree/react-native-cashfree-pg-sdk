...
RCT_EXTERN_METHOD(doElementNBPayment:(NSString)paymentObject)
RCT_EXTERN_METHOD(doElementUPIPayment:(NSString)paymentObject)
RCT_EXTERN_METHOD(doSubsCardPayment:(NSString)paymentObject)
RCT_EXTERN_METHOD(doSubsUPIPayment:(NSString)paymentObject)
RCT_EXTERN_METHOD(doSubsNBPayment:(NSString)paymentObject)

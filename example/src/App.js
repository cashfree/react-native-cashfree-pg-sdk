...
export default class App extends Component {
    constructor() {
        ...
        this.state = {
            ...
            sessionId: 'session_Ivf6gFkwtiAY4WxqgjuyPkAq9MpAQRe6WOi5BrJNzpEduX0w5BK-DwWpntSL3Lj9Xto9wFzJHAESbKVNLeeWOFec0HtCrXUusNFYdc7BVLfk3RenGY_DDvP-sAcpayment',
            instrumentId: '',
    ...
    getSession() {
        return new CFSession(this.state.sessionId, this.state.orderId, this.state.cfEnv === 'PRODUCTION'
